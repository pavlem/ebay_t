...
class CountryUtilities {
    ...
    class func getAlphaTwoCode(byAlpha3Code alpha3code: String) -> String? {
        return countries.someKey(forValue: alpha3code)
    }
    
    class func getFlag(for twoLetterCode: String) -> String {
                let unicodeScalars = twoLetterCode
            .unicodeScalars
